...
//import com.example.dbdemo.adapter.*;
//import com.example.dbdemo.dao.UtilDao;
...
//         * 创建并绑定适配器
//         * */
//        adapter = new MyAdapter(this,R.layout.activity_item_old,list);
...
//                        startActivity(intent);
//                        break;
//                    case 2: intent = new Intent(MainActivity_old.this, AddData_old.class);
...
//        switch (view.getId()){
//            case R.id.main_but:
//                //跳转到 AddData_old Activity 传入请求码 1
//                Intent intent = new Intent(MainActivity_old.this, AddData_old.class);
